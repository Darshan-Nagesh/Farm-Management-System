...
**2. View users’ Medicine details:**
  ...
  &nbsp; &nbsp; &nbsp; Here, the user can see the medicine details.(See Fig 1.8).
...
**4. View the Medicine lists:**
  ...
  &nbsp; &nbsp; &nbsp; Admin can also able to see the entire details of the medicines(See Fig 1.17). 
...
**5. View the Method lists:**
  ...
  &nbsp; &nbsp; &nbsp; Admin can also able to see the entire details of the methods(See Fig 1.17). 
